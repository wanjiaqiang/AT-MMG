...
// https://github.com/facebookresearch/faiss/wiki/Fast-accumulation-of-PQ-and-AQ-codes-(scan)
...
// pack lookup table for scan, for each 4 dim, we have 16 (2^4) different results
// ! dim % 4 == 0
template <typename T>
