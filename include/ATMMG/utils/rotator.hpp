...
#if !defined(_MSC_VER)
#include "ATMMG/utils/fht_avx.hpp"
#else
inline void ATMMGlib_scalar_fht_float(float* buf, int log_n) {
    const int n = 1 << log_n;
...
inline void helper_float_6(float* buf) { ATMMGlib_scalar_fht_float(buf, 6); }
inline void helper_float_7(float* buf) { ATMMGlib_scalar_fht_float(buf, 7); }
inline void helper_float_8(float* buf) { ATMMGlib_scalar_fht_float(buf, 8); }
inline void helper_float_9(float* buf) { ATMMGlib_scalar_fht_float(buf, 9); }
inline void helper_float_10(float* buf) { ATMMGlib_scalar_fht_float(buf, 10); }
inline void helper_float_11(float* buf) { ATMMGlib_scalar_fht_float(buf, 11); }
#endif
...
Rotator<T>* choose_rotator(
    ...
    if (padded_dim == 0) {
        ...
        if (padded_dim != dim) {
            ...
            std::cerr << "check ATMMG/utils/rotator.hpp in case that users want to "
                         "remove padding\n";
        }
    }
